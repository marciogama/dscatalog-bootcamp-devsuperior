...
public class UserService {
	...
	public Page<UserDTO> findAllPaged(PageRequest pageRequest) {
		...
		return list.map(x -> new UserDTO(x)); // solução utilizando expressão lâmbida
	}
	...
	private void copyDtoToEntity(UserDTO dto, User entity) {
		...
		entity.getRoles().clear(); //limpo a lista para ter certeza que ela está vazia antes de receber novas informações
